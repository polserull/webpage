...
L.marker([51.49774320425926, -0.6369741664371422], {icon: damagingLightningMarker}).addTo(map).bindPopup(`<pre>Damaging Lightning
Estimate Location: Eton Wick
[51.49774320425926, -0.6369741664371422] [02-05-24 N/A]
Source: News | <a href="https://www.windsorexpress.co.uk/gallery/appeals-and-information/196332/firefighters-tackle-eton-wick-loft-fire-caused-by-a-lightning-strike.html">Source</a><pre>`);
L.marker([50.823979952034136, 0.23899878220061452], {icon: damagingLightningMarker}).addTo(map).bindPopup(`<pre>Damaging Lightning
Estimate Location: Brookside Avenue, Polegate
[50.823979952034136, 0.23899878220061452] [02-05-24 01:05BST]
Source: News | <a href="https://www.theargus.co.uk/news/24293336.live-updates-sussex-hit-thunder-lightning/">Source</a></pre>`);
L.marker([50.84447198006771, -0.7757965582763232], {icon: damagingLightningMarker}).addTo(map).bindPopup(`<pre>Damaging Lightning
Estimate Location: College Lane, Chichester
[50.84447198006771, -0.7757965582763232] [02-05-24 02:24BST]
Source: News | <a href="https://www.theargus.co.uk/news/24293336.live-updates-sussex-hit-thunder-lightning/"><Source</a></pre>`);
L.marker([50.79254272710808, -0.6104020396560259], {icon: damagingLightningMarker}).addTo(map).bindPopup(`<pre>Damaging Lightning
Estimate Location: Elmer, Bognor 
[50.79254272710808, -0.6104020396560259] [02-05-24 1:44BST]
Source: News | <a href="https://www.theargus.co.uk/news/24293336.live-updates-sussex-hit-thunder-lightning/">Source</a></pre>`);
L.marker([57.310200010485474, -2.6233588484252075], {icon: floodingMarker}).addTo(map).bindPopup(`<pre>Flooding
Estimate Location: Auchleven, Aberdeenshire 
[57.310200010485474, -2.6233588484252075] [05-05-24 N/A]
Source: Twitter | <a href="https://twitter.com/Alonso2012F/status/1787180019363487791">Source</a></pre>`);
L.marker([52.41099743933818, -3.3476055264083038], {icon: floodingMarker}).addTo(map).bindPopup(`<pre>Flooding
Estimate Location: A483, Llanbadarn Fynydd 
[52.41099743933818, -3.3476055264083038] [12-05-24 19:00BST]
Source: News | <a href="https://www.countytimes.co.uk/news/24314854.live-powys-flooding-latest-uk-thunderstorms/">Source</a></pre>`);
L.marker([53.60835803921186, -2.314070824203321], {icon: damagingLightningMarker}).addTo(map).bindPopup(`<pre>Damaging Lightning
